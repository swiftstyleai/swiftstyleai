...
describe('components/CharactersPage/contexts/actions', () => {
  ...
  describe('addCharacter', () => {
    it('should create an ADD_CHARACTER action with the correct payload', () => {
      const character = {
        created_at: '2024-07-26T00:00:00Z',
        description: 'Style description 1',
        id: 'style-123',
      ...
      const expectedAction = createExpectedAction(ADD_CHARACTER, character);
  ...
  describe('deleteCharacter', () => {
    it('should create a DELETE_CHARACTER action with the correct payload', () => {
      ...
      const action = deleteCharacter(characterId);
